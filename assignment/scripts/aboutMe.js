...
let fullName = firstName + lastName //I'm not sure how I would insert a space between the variables.
//I tried to use a comma but that produced an error.
...
if (pets === friendsPets) {
  mostPets = "One of us is gonna need another doge."
}
